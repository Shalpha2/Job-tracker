document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch("https://my-json-server.typicode.com/Shalpha2/Job-tracker/applications")
  ...
  function handleDelete(appId, li) {
    fetch(`https://my-json-server.typicode.com/Shalpha2/Job-tracker/applications/${appId}`, {
      method: "DELETE",
    })
      .then((response) => {
        if (response.ok) {
